...
public class ModeController : MonoBehaviour {
    ...
    public GameObject Setting, Continue, Score, QuitGame, Profil, Changenick, ChangeAvatar;
    public ScoreController ScoreControl;
    public bool IsShowScreen;
    public ProfileHandler profileHandler;
    public SettingHandler settingcode;
    ...
    void Update()
    {
        if (IsShowScreen)
        {
            if (Input.GetKeyDown(KeyCode.Escape))
            {
                ...
                else if (Profil.activeSelf && ChangeAvatar.activeSelf == false && Changenick.activeSelf == false)
                {
                    Profil.SetActive(false);
                    SoundManager.instance.SoundOn(SoundManager.SoundIngame.Click);
                }
                else if (ChangeAvatar.activeSelf)
                {
                    ChangeAvatar.SetActive(false);
                    SoundManager.instance.SoundOn(SoundManager.SoundIngame.Click);
                }
                else if (Changenick.activeSelf)
                {
                    Changenick.SetActive(false);
                    SoundManager.instance.SoundOn(SoundManager.SoundIngame.Click);
                }
                ...
                else if (QuitGame.activeSelf && Setting.activeSelf)
                {
                    // HideQuitGame();
