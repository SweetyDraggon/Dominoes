...
public class EndMatchController : MonoBehaviour {
    ...
    public Image bot1Sprite, bot2Sprite, bot3Sprite;
    ...
    void loadInfoData()
    {
        ...
        playerNameText.text= PlayGameController.playerNameText.text.ToString();
        playerScoreText.text = PlayGameController.totalPlayerScore + "/" + PlayGameController.targetScore;
        if (PlayGameController.CurrentMaxPlayer == 2)
        {
         
            bot1BScoreText.text = PlayGameController.totalBot1Score + "/" + PlayGameController.targetScore;

         
        }
        else
        {         
            bot1SScoreText.text = PlayGameController.totalBot1Score + "/" + PlayGameController.targetScore;
                    
            bot2ScoreText.text = PlayGameController.totalBot2Score + "/" + PlayGameController.targetScore;
                          
            bot3ScoreText.text = PlayGameController.totalBot3Score + "/" + PlayGameController.targetScore;
